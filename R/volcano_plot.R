#' volcano_plot: Optimized volcano plot for Seurat differential expression (FindMarkers) output
#'
#' @description
#' Uses ggplot2 to create a generic volcano plot from the differential expression table generated by Seurat
#'
#' @param de_table Differential expression table generated by Seurat containing p_val, pct.1, pct.2 avg_log2FC and p_val_adj
...
volcano_plot <- function(de_table, significant = TRUE, logfc = TRUE, pval = TRUE) {
