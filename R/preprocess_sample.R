...
#' 
#' @description: Conducts preliminary normalization/scaling, cell cycle scoring, and clustering on a Seurat single cell object
#' 
#' @details 
...
#' - Principal components analysis, neighbor identification, UMAP dimensionality reduction and preliminary clustering (through `seurat_clustering` function) 
#' 
#' @param so_in A Seurat single cell object with RNA counts
#' @param species Species of the sample (hg38, hg19, or mm10)
#' @param npcs_in Number of principal components to use for dimensionality reduction
#' 
